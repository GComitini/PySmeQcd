...
1. Download the source code from `GitHub <https://github.com/GComitini/PySmeQcd/releases/download/v1.0.0-alpha.2/PySmeQcd-1.0.0a2.tar.gz>`_.

  .. code-block:: console

    $ wget https://github.com/GComitini/PySmeQcd/releases/download/v1.0.0-alpha.2/PySmeQcd-1.0.0a2.tar.gz

2. Unpack the archive and :console:`cd` into the :file:`PySmeQcd-1.0.0a2/src` directory.
